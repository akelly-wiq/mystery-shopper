...
**Architecture:** Multi-Agent RAG System with Basket-Level Validation
...
✅ **RAG retrieval component** - finds relevant products per ingredient  
...
**Purpose:** Find relevant products for each ingredient

**Process:**
- Query BigQuery tables (WW, Coles, Aldi) per ingredient
- Return top candidate products with metadata
- Filter by: price range, pack size, category, promotions
