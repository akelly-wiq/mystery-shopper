...
- Hybrid semantic search (keywords + embeddings)

**Data Pipeline:**
Product extraction → Multi-agent voting → Evaluation → BigQuery storage
...
- Evaluation agent with rejection limits
- Conscious, Refined, Essential personas
...
**Data Sources:**
- Woolworths: Internal product table + historical data (`gcp-wow-ent-im-tbl-prod.adp_dm_betterbuying_view.Sell_Price_Weekly_v`)
- Coles: PCB competitor table (~20K products)
- Aldi: PCB table + selective enrichment (~100 products)
