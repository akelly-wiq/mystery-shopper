...
**REFINED:** Most affluent segment. Quality over price always. Premium brands, best cuts, respected products. "Would I be proud to serve this?" Price is NOT a factor.
...
- **Highest affluence** (Premium 2.2x)
- **Highest quality priority** (77.0%)
- **Lowest price sensitivity** (45.9%)
- **Lowest promo engagement** (29.7%)
- **Lowest own brand** adoption
- **2x more likely** to shop UP/Metro stores
