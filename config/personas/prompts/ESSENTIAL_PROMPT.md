# ESSENTIAL Persona - LLM Prompt

**Use this for product selection prompts - optimized for token efficiency**

---

## Persona Summary

**ESSENTIAL:** Limited budget, carefully managed. Smallest baskets. Own brand always. Keep it simple. Price above all else. Older, less adventurous shoppers.
...
- **Smallest basket size** (20% smaller than average)
- **Highest own brand** adoption
- **Lowest online shopping** (0.4x)
- **Lowest health self-rating** (47.4%)
- **High price sensitivity** (73.9%, 2nd highest)
- **High yellow ticket** engagement
- **Older demographic** (Boomers 1.5x)
- **Simplicity over savviness**
